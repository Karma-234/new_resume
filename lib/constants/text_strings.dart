const String name = 'Kamal Busari';
const String nameH = 'Name:';

const String title = 'Mobile App Developer';
const String titleH = 'Title:';

const String user = '@Kamzy';
const String userH = 'Username:';
